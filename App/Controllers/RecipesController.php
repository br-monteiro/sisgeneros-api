...
class RecipesController
{
    ...
    {
        return RecipesModel::find($args['id'], $response);
    }
    ...
    {
        return RecipesModel::findAll($request, $response);
    }
    ...
    {
        return RecipesModel::create($request, $response);
    }
    ...
    {
        return RecipesModel::update($args['id'], $request, $response);
    }
    ...
    {
        return RecipesModel::remove($args['id'], $response);
    }
}
