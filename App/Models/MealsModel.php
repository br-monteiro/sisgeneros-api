...
class MealsModel extends AbstractModel
{
    ...
    public static function findAll(Request $request, Response $response): Response
    {
        try {
            ...
            $paginator = paginator::buildAttributes($request, 'meals');
            $limit = $paginator->limit;
            $offset = $paginator->offset;
            $repository = db::em()->getRepository(Meals::class);
            $entity = $repository->findBy([], ['sort' => 'ASC'], $limit, $offset);
    ...
    public static function create(Request $request, Response $response): Response
    {
        ...
        if (!self::inputValidate($data, 'meals_schema.json')) {
            return $response->withJson([
